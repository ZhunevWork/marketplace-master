...
export class ProductResolverBase {
  ...
  @graphql.ResolveField(() => [MarketplaceSync], { name: "marketplaceSyncs" })
  async findMarketplaceSyncs(
    ...
    const results = await this.service.findMarketplaceSyncs(parent.id, args);
  ...
  @graphql.ResolveField(() => [OfferCard], { name: "offerCards" })
  async findOfferCards(
    @graphql.Parent() parent: Product,
    @graphql.Args() args: OfferCardFindManyArgs
  ): Promise<OfferCard[]> {
    const results = await this.service.findOfferCards(parent.id, args);
  ...
  async getAccount(@graphql.Parent() parent: Product): Promise<Account | null> {
